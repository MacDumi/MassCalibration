...
#initialize everything
	...
	def listItemRightClicked(self, QPos):
		...
		self.connect(menu_item, SIGNAL("triggered()"), self.menuRemoveClicked)
		self.connect(menu_item_1, SIGNAL("triggered()"), self.menuPlotClicked)
		self.connect(menu_item_2, SIGNAL("triggered()"), self.menuUpClicked)
		self.connect(menu_item_3, SIGNAL("triggered()"), self.menuDownClicked)
