...
# Form implementation generated from reading ui file 'layouts/crop_dialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(276, 145)
        Dialog.setMaximumSize(QtCore.QSize(284, 145))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("layouts/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout.addWidget(self.lbl_max, 1, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_max, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_min, 1, 0, 1, 2)
